...
# Parameters
imgPath = "./img/lion.jpg"
imgRadius = 550     # Number of pixels that the image radius is resized to
...
if __name__=="__main__":
    ...
    for line in range(nLines):
        ...
        for index in range(1, nPins):
            ...
            # The bigger the value, the darker the the line, beacause the colors are inverted
        ...
        # Substract from the inverted image de lineWeight along the line
        ...
        oldPins.append((oldPin, oldPin))
        oldPin = bestPin

        # Add best pin to array of pins
        bestPins.append((bestPin, bestPin))
    ...
    #     csv_output.write(csver(lines[l[0]],lines[l[1]]))
    # csv_output.close()
    print lines
    with open('threaded.csv', 'wb') as myfile:
